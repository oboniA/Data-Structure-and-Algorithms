"""
----------Frequency of a single count_element in the list-------------
"""
print('Frequency of a given count_element in the list')
list1 = [10,10,10,10,20,20,20,20,40,40,50,50,30]
count = 0
count_element = 30

for i in list1:                                         # for elements in the list
    if count_element == i:                              # if the count_element is same as the element:i
...
for j in list2:                   # for elements in the list
    if j in count2:               # if the count_element is already in the count list,
